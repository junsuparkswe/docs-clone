        ...
        {lineHeights.map(({ label, value }) => (
          <button
            ...
            className={cn(
              ...
              editor?.getAttributes("pargraph").lineHeight === value && "bg-neutral-200/80"
            )}
          >
    ...
    <div className="flex items-center gap-x-0.5">
      ...
      {isEditing ? (
        ...
        <button
          ...
          className="h-7 w-10 text-sm border border-neutral-400 text-center rounded-sm bg-transparent curosr-text"
        >
          {currentFontSize}
        </button>
      )}
